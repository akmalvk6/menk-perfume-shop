export default function About() {
  return (
    <section className="shell grid gap-10 py-12 lg:grid-cols-[0.9fr_1.1fr]">
      <div>
        <p className="text-sm font-semibold uppercase tracking-wide text-saffron">About</p>
        <h1 className="font-display text-4xl font-bold tracking-normal">Fragrance with a personal buying experience.</h1>
      </div>
